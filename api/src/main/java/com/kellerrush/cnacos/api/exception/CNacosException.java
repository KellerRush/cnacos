...
package com.kellerrush.cnacos.api.exception;


import com.kellerrush.cnacos.api.common.Constants;
import com.kellerrush.cnacos.api.utils.StringUtils;
 ...
 * @author Nacos
 */
public class CNacosException extends Exception {
    ...
    public CNacosException() {
    }

    public CNacosException(final int errCode, final String errMsg) {
        super(errMsg);
        this.errCode = errCode;
        this.errMsg = errMsg;
    }

    public CNacosException(final int errCode, final Throwable throwable) {
        super(throwable);
        this.errCode = errCode;
        this.setCauseThrowable(throwable);
    }

    public CNacosException(final int errCode, final String errMsg, final Throwable throwable) {
