 ...
 * @author yangyi
 */
public class CNacosRuntimeException extends RuntimeException {
    ...
    public CNacosRuntimeException(int errCode) {
        super();
        this.errCode = errCode;
    }
    
    public CNacosRuntimeException(int errCode, String errMsg) {
        super(String.format(ERROR_MESSAGE_FORMAT, errCode, errMsg));
        this.errCode = errCode;
    }
    
    public CNacosRuntimeException(int errCode, Throwable throwable) {
        super(throwable);
        this.errCode = errCode;
    }
    
    public CNacosRuntimeException(int errCode, String errMsg, Throwable throwable) {
